...
if(isset($_POST['update_acc'])){
       ...
       $sql = "UPDATE department SET name='$name' WHERE id='$editid' ";
  ...
  //Delete teacher    
        if(isset($_POST['delete_acc'])){
              ...
              $sql = "DELETE FROM department WHERE id='$deleteid' ";
              mysqli_query($db,$sql);
              $message="Deleted";
          }
?>
...
<body>
    ...
    <div id="right-panel" class="right-panel">
       ...
       <div class="content">
        ...
        ?>
	   		<input type="submit" name="add" class="btn btn-info" value="Add New Department" data-toggle="modal" data-target="#add" style="width: 200px;"><br>
        <?php
      }
        ?>
